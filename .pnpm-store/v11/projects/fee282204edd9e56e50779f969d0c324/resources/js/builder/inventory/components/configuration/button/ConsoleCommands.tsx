...
const ConsoleCommands = ({currentSlot, handleChange}) => {
    ...
    return (
        <Form.Group>
            <hr/>
            <Form.Label>控制台命令 <a className={'ms-2'} href={'https://docs.zmenu.dev/configurations/buttons#console-commands'} target={'_blank'}>(<i className="bi bi-question-lg"></i>)</a></Form.Label>
