...
const Sound = ({sounds, currentSlot, handleChange}) => {
    ...
    return (
        <div className={'mb-3'}>
            <hr/>
            <Form.Label>声音 <a className={'ms-2'} href={'https://docs.zmenu.dev/configurations/buttons#sound'} target={'_blank'}>(<i className="bi bi-question-lg"></i>)</a></Form.Label>
            <SearchableSelect key={'sound'} options={sounds} handleChange={handleChange} name={'sound'} defaultValue={currentSlot.button.sound}/>
            <div className={'row mt-2'}>
                <div className={'col-6'}>
                    <Form.Group>
                        <Form.Label>音调</Form.Label>
                        <Form.Control
                            name="pitch"
                            type="number"
                            min={0}
