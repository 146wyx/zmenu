...
const Inventory = ({
    ...
    const processedName = inventory.name ? DOMPurify.sanitize(minecraftColor.processMinecraftColorCodes(inventory.name)) : '菜单';
    ...
    return (<div className={"inventory-builder-center"}>
        <HeaderInformation needToUpdate={needToUpdate} saveData={saveData} onDownload={onDownload} onImport={onImport}/>
